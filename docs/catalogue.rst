...
.. script location: example_scripts/show_altered_uncertainties.py
.. code-block:: python
    ...
    freq, band, flux, flux_err, limit_signs, ref = cat_dict["J1316-6232"]
    print(f"J1316-6232 flux: {flux[0]} ± {flux_err[0]} mJy")
    freq, band, flux, flux_err, limit_signs, ref = cat_dict["J1327-6222"]
